...
#define DEM // enables DEM particles with partially saturated method. This enables accurate particle dynamics for full solid-fluid coupling.
...
#ifdef DEM // (rho, u) need to be updated exactly every lbm timestep
